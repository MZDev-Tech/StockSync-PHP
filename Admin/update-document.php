...
if (isset($_POST['submit'])) {
    ...
    $query = "update documents set name=?, description=? where id=?";
           ...
           <div class="form-parent">
                <div class="form-records">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <textarea type="text" name="detail" id="editor"  placeholder="Type Details.." class="form-control"
                        value="<?php echo $row['description']; ?>"><?php echo $row['description']; ?></textarea>                        </div>
